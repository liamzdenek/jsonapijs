...
function RamResource() {
    ...
    this.update = function(req) {
        console.log("IN RamResource Update -- "+req.data.document);
        return new Promise(function(resolve, reject) {
            if(req.data.id == null) {
            ...
            data[req.data.id] = Object.assign(data[req.data.id], req.data.document)
    ...
    this.check_rollback_update = function(req, promise) {
        promise.catch(function() {
            console.log("TODO: Rollback update");
        });
    }
}
