...
ExceptionBuilder.prototype.include_stack = function() {
    this._meta = this._meta || {};
    this._meta.stack = new Error().stack;
    return this;
}

ExceptionBuilder.prototype.print_stack = function() {
    this.include_stack()
    console.log(this._meta.stack);
    return this;
}
