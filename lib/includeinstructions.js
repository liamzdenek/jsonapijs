...
IncludeInstructions.prototype.push_hidden = function(inst_rels) {
    if(!this.children[inst_rels]) {
        this.children[inst_rels] = new IncludeInstructions();
    }
}
